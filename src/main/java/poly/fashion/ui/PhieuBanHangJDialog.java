...
import poly.fashion.dao.PhieuBanHangDAO;
import poly.fashion.dao.impl.PhieuBanHangDAOImpl;
import poly.fashion.dao.impl.PhieuBanHangDAOImpl;
import poly.fashion.entity.PhieuBanHang;
import poly.fashion.entity.PhieuBanHang;
import poly.fashion.util.TimeRange;
//import poly.fashion.util.XDate;
 ...
 * @author DELL
 */
public class PhieuBanHangJDialog extends javax.swing.JDialog {

    /**
     * Creates new form BillJDialog
     */
    public PhieuBanHangJDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tblBillDetails.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Quần áo", "Đơn giá", "Số lượng", "Thành tiền"
            }
        ) {
            boolean[] canEdit = new boolean [] {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PhieuBanHangJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PhieuBanHangJDialog dialog = new PhieuBanHangJDialog(new javax.swing.JFrame(), true);
    ...
    PhieuBanHangDAO dao = new PhieuBanHangDAOImpl();
    List<PhieuBanHang> items = List.of();
    PhieuBanHangDAO billDetailDao = new PhieuBanHangDAOImpl();
    List<PhieuBanHang> details = List.of();
